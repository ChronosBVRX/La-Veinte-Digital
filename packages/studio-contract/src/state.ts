...
/** Estados del progreso visual de cada paso en el estudio */
export const STEP_PROGRESS_STATES = [
  "pendiente",
  "en_curso",
  "completado",
  "error",
...
export type StepProgressState = (typeof STEP_PROGRESS_STATES)[number];

/** Pares de producción (solo Estado -> Estado permitido). */
export const STEP_TRANSITIONS: Record<ProjectState, ProjectState[]> = {
  DRAFT: ["RESEARCHING", "SCRIPT_READY"],
  RESEARCHING: ["RESEARCHED", "FAILED", "DRAFT"],
  RESEARCHED: ["RESEARCHING", "GENERATING_PROPOSALS", "PROPOSAL_READY", "DRAFT"],
  GENERATING_PROPOSALS: ["PROPOSAL_READY", "PROPOSAL_GENERATION_FAILED", "FAILED", "DRAFT"],
  PROPOSAL_READY: ["RESEARCHED", "PROPOSAL_APPROVED"],
  PROPOSAL_APPROVED: ["PROPOSAL_READY", "SCRIPT_GENERATING", "SCRIPT_GENERATION_FAILED", "SCRIPT_QUALITY_FAILED"],
  PROPOSAL_GENERATION_FAILED: ["GENERATING_PROPOSALS", "RESEARCHED", "DRAFT"],
  SCRIPT_GENERATING: ["SCRIPT_READY", "SCRIPT_GENERATION_FAILED", "SCRIPT_QUALITY_FAILED", "FAILED", "PROPOSAL_APPROVED"],
  SCRIPT_READY: ["SCRIPT_GENERATING", "SCRIPT_APPROVED", "NEEDS_REVIEW", "PRODUCING"],
  SCRIPT_APPROVED: ["SCRIPT_READY", "PRODUCING"],
  SCRIPT_GENERATION_FAILED: ["SCRIPT_GENERATING", "PROPOSAL_APPROVED", "DRAFT"],
  SCRIPT_QUALITY_FAILED: ["SCRIPT_GENERATING", "PROPOSAL_APPROVED", "DRAFT"],
