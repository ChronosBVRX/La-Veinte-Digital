...
interface TemplateSeedConfig {
  kind: 'license_word' | 'license_excel';
  localPath: string;
  storagePath: string;
  mimeType: string;
...
const TEMPLATES: TemplateSeedConfig[] = [
  {
    ...
    storagePath: `templates/licencias/oficio/${VERSION}/oficio-licencia-delegacion-xxi.docx`,
    mimeType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    expectedMinSize: 50000,
  },
  {
    kind: 'license_excel',
    localPath: 'assets/templates/union/licencias/formato-licencia-1A74-009-036.xlsm',
    storagePath: `templates/licencias/formato-1A74-009-036/${VERSION}/formato-licencia-1A74-009-036.xlsm`,
    mimeType: 'application/vnd.ms-excel.sheet.macroEnabled.12',
    expectedMinSize: 40000,
  }
];
