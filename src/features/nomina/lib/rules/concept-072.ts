 ...
 * importe REAL comprobado. SIN porcentaje autorizado la regla no es
 * computable: el ancla puede repetirse como referencia marcada para
 * confirmación (nunca como cálculo).
 */
