...
export const CALCULATOR_POLICIES: Record<CalculatorId, CalculatorPrefillPolicy> = {
  ...
  "segunda-julio": {
    ...
    includeDaysWorked: false,
    notes: [
      "Régimen ordinario: la base se integra con el sueldo tabular (002) y la ayuda de renta (011) conforme a Cláusula 144 y Cláusula 63 Bis inc. b CCT.",
      "Se prerrellenan 002 y 011.",
      "El 022 NO forma parte de esta fórmula.",
      "La fórmula ((002 + 011) ÷ 15) × 46 presume año completo salvo unidades confirmadas.",
    ],
  },
