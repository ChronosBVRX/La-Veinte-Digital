...
export const PASSAGE_027_FIELDS: Record<string, PdfOverlayField> = {
  ...
  paternalSurname: { page: 0, x: 140, y: 585, align: "center", width: 175, fontSize: 7.0, minFontSize: 5.5 },
  maternalSurname: { page: 0, x: 320, y: 585, align: "center", width: 175, fontSize: 7.0, minFontSize: 5.5 },
  firstName: { page: 0, x: 497, y: 585, align: "center", width: 155, fontSize: 7.0, minFontSize: 5.5 },
  ...
  assignment: { page: 0, x: 110, y: 561, width: 250, fontSize: 7.5, minFontSize: 5.5 },
  discontinuousYes: { page: 0, x: 546, y: 561, align: "center", fontSize: 8.5, bold: true },
  discontinuousNo: { page: 0, x: 578, y: 561, align: "center", fontSize: 8.5, bold: true },
  workerStreet: { page: 0, x: 155, y: 536, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  assignmentStreet: { page: 0, x: 370, y: 536, width: 210, fontSize: 7.0, minFontSize: 5.5 },
  workerNeighborhood: { page: 0, x: 155, y: 524, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  assignmentNeighborhood: { page: 0, x: 370, y: 524, width: 210, fontSize: 7.0, minFontSize: 5.5 },
  workerPostalCode: { page: 0, x: 155, y: 512, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  assignmentPostalCode: { page: 0, x: 370, y: 512, width: 210, fontSize: 7.0, minFontSize: 5.5 },
  workerMunicipality: { page: 0, x: 155, y: 500, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  assignmentMunicipality: { page: 0, x: 370, y: 500, width: 210, fontSize: 7.0, minFontSize: 5.5 },
  workerState: { page: 0, x: 155, y: 488, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  assignmentState: { page: 0, x: 370, y: 488, width: 210, fontSize: 7.0, minFontSize: 5.5 },
  phone: { page: 0, x: 155, y: 476, width: 205, fontSize: 7.0, minFontSize: 5.5 },
  privacyWorkerName: { page: 1, x: 306.5, y: 142, align: "center", width: 230, fontSize: 8.5, minFontSize: 6.5 },
};
