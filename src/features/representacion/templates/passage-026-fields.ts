...
export const PASSAGE_026_FIELDS: Record<string, PdfOverlayField> = {
  ...
  day: { page: 0, x: 105, y: 641, align: "center", fontSize: 7.5 },
  month: { page: 0, x: 152, y: 641, align: "center", fontSize: 7.5 },
  year: { page: 0, x: 176.5, y: 641, align: "center", fontSize: 7.5 },
  controlNumber: { page: 0, x: 521, y: 641, align: "center", width: 84, fontSize: 7.0, minFontSize: 5.5 },
  paternalSurname: { page: 0, x: 162, y: 603, align: "center", width: 170, fontSize: 6.0, minFontSize: 5.0 },
  maternalSurname: { page: 0, x: 332, y: 603, align: "center", width: 145, fontSize: 6.0, minFontSize: 5.0 },
  firstName: { page: 0, x: 488, y: 603, align: "center", width: 145, fontSize: 6.0, minFontSize: 5.0 },
