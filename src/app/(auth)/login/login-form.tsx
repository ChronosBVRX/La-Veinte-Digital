    ...
    <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem" }}>
          <Button type="button" variant="secondary" style={{ flex: 1, justifyContent: "center" }} onClick={() => signInWithOAuth("google")}>
          ...
          <Button type="button" variant="secondary" style={{ flex: 1, justifyContent: "center" }} onClick={() => signInWithOAuth("facebook")}>
            <svg width="16" height="16" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
