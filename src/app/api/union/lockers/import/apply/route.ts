...
import { applyLockerImportBatch } from "@/features/representacion/services/worker-importer/locker-importer";
...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : "Error al aplicar la importación de casilleros.";
    const status =
