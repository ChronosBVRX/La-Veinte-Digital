...
import { rollbackImportBatch } from "@/features/representacion/services/worker-importer/batch-executor";
...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : "Error al revertir la importación.";
