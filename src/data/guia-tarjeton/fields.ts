// ÍNDICE PROVISIONAL de campos del tarjetón (códigos y temas a investigar).
// No es autoridad normativa; la validación contra fuentes oficiales se hace
// aparte (sources.ts + estados de verificación).
